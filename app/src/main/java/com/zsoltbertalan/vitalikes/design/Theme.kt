package com.zsoltbertalan.vitalikes.design
...
val VitalikesLightColorScheme = lightColorScheme(
...
private val VitalikesDarkColorScheme = darkColorScheme(
...
fun VitalikesTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> VitalikesDarkColorScheme
		else -> VitalikesLightColorScheme
	}
	...
	ProvideDimens(dimensions = dimensions) {
		ProvideColors(colorScheme = colorScheme) {
			MaterialTheme(
				colorScheme = colorScheme,
				typography = VitalikesTypography,
				content = content
			)
		}
	}
...
val Dimens: Dimensions
	@Composable
	get() = VitalikesTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = VitalikesTheme.colorScheme
