...
android {
	...
	namespace = "com.zsoltbertalan.vitalikes"

	defaultConfig {
		applicationId = "com.zsoltbertalan.vitalikes"
		...
		compileSdk = 34
		targetSdk = 34
		testInstrumentationRunner = "com.zsoltbertalan.vitalikes.VitalikesAndroidJUnitRunner"
	}
